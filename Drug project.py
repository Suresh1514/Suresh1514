...
def load_data(file=None):
    try:
        ...
        return data[data['condition'].isin(conditions)]
    except Exception as e:
        st.error(f"Failed to load dataset: {e}")
        return pd.DataFrame()

# Train ML model on review text
...
if not data.empty:
    ...
    review_input = st.text_area("For example: *'This medicine helped me sleep and lifted my mood.'*")
